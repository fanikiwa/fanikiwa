...
public class Userprofileendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class UserprofileEndpoint {
    ...
    /**
     * Create a request for the method "userprofileEndpoint.authenticatedByPhone".
     *
     * This request holds the parameters needed by the userprofileendpoint server.  After setting any
     * optional parameters, call the {@link AuthenticatedByPhone#execute()} method to invoke the remote
     * operation.
     *
     * @param telephone
     * @param pwd
     * @return the request
     */
    public AuthenticatedByPhone authenticatedByPhone(java.lang.String telephone, java.lang.String pwd) throws java.io.IOException {
      AuthenticatedByPhone result = new AuthenticatedByPhone(telephone, pwd);
      initialize(result);
      return result;
    }

    public class AuthenticatedByPhone extends UserprofileendpointRequest<com.sp.fanikiwa.entity.userprofileendpoint.model.Userprofile> {

      private static final String REST_PATH = "AuthenticatedByPhone/{telephone}/{pwd}";

      /**
       * Create a request for the method "userprofileEndpoint.authenticatedByPhone".
       *
       * This request holds the parameters needed by the the userprofileendpoint server.  After setting
       * any optional parameters, call the {@link AuthenticatedByPhone#execute()} method to invoke the
       * remote operation. <p> {@link AuthenticatedByPhone#initialize(com.google.api.client.googleapis.s
       ...
       * @since 1.13
       */
      protected AuthenticatedByPhone(java.lang.String telephone, java.lang.String pwd) {
      ...
      @Override
      public AuthenticatedByPhone setAlt(java.lang.String alt) {
        return (AuthenticatedByPhone) super.setAlt(alt);
      }

      @Override
      public AuthenticatedByPhone setFields(java.lang.String fields) {
        return (AuthenticatedByPhone) super.setFields(fields);
      }

      @Override
      public AuthenticatedByPhone setKey(java.lang.String key) {
        return (AuthenticatedByPhone) super.setKey(key);
      }

      @Override
      public AuthenticatedByPhone setOauthToken(java.lang.String oauthToken) {
        return (AuthenticatedByPhone) super.setOauthToken(oauthToken);
      }

      @Override
      public AuthenticatedByPhone setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (AuthenticatedByPhone) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public AuthenticatedByPhone setQuotaUser(java.lang.String quotaUser) {
        return (AuthenticatedByPhone) super.setQuotaUser(quotaUser);
      }

      @Override
      public AuthenticatedByPhone setUserIp(java.lang.String userIp) {
        return (AuthenticatedByPhone) super.setUserIp(userIp);
      }
      ...
      public AuthenticatedByPhone setTelephone(java.lang.String telephone) {
      ...
      public AuthenticatedByPhone setPwd(java.lang.String pwd) {
        this.pwd = pwd;
        return this;
      }

      @Override
      public AuthenticatedByPhone set(String parameterName, Object value) {
        return (AuthenticatedByPhone) super.set(parameterName, value);
      }
    }
