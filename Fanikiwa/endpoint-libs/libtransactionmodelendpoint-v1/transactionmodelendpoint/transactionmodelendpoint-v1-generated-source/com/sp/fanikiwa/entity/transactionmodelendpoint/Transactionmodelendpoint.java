...
public class Transactionmodelendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetTransactionModel extends TransactionmodelendpointRequest<com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel> {
    ...
    protected GetTransactionModel(java.lang.Long id) {
      super(Transactionmodelendpoint.this, "GET", REST_PATH, null, com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel.class);
   ...
   * remote operation.
   *
   * @param content the {@link com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel}
   * @return the request
   */
  public InsertTransactionModel insertTransactionModel(com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel content) throws java.io.IOException {
    InsertTransactionModel result = new InsertTransactionModel(content);
    initialize(result);
    return result;
  }

  public class InsertTransactionModel extends TransactionmodelendpointRequest<com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel> {

    private static final String REST_PATH = "transactionmodel";
     ...
     * @since 1.13
     */
    protected InsertTransactionModel(com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel content) {
      super(Transactionmodelendpoint.this, "POST", REST_PATH, content, com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel.class);
    }
  ...
  public class ListTransactionModel extends TransactionmodelendpointRequest<com.sp.fanikiwa.entity.transactionmodelendpoint.model.CollectionResponseTransactionModel> {
    ...
    protected ListTransactionModel() {
      super(Transactionmodelendpoint.this, "GET", REST_PATH, null, com.sp.fanikiwa.entity.transactionmodelendpoint.model.CollectionResponseTransactionModel.class);
    }
   ...
   * @return the request
   */
  public UpdateTransactionModel updateTransactionModel(com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel content) throws java.io.IOException {
    UpdateTransactionModel result = new UpdateTransactionModel(content);
    initialize(result);
    return result;
  }

  public class UpdateTransactionModel extends TransactionmodelendpointRequest<com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel> {
     ...
     * @since 1.13
     */
    protected UpdateTransactionModel(com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel content) {
      super(Transactionmodelendpoint.this, "PUT", REST_PATH, content, com.sp.fanikiwa.entity.transactionmodelendpoint.model.TransactionModel.class);
    }
