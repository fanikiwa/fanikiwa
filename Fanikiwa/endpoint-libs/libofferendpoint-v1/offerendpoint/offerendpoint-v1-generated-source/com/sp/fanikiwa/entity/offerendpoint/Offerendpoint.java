...
public class Offerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "privateOffersToMember".
   *
   * This request holds the parameters needed by the offerendpoint server.  After setting any optional
   * parameters, call the {@link PrivateOffersToMember#execute()} method to invoke the remote
   * operation.
   *
   * @param memberid
   * @return the request
   */
  public PrivateOffersToMember privateOffersToMember(java.lang.Long memberid) throws java.io.IOException {
    PrivateOffersToMember result = new PrivateOffersToMember(memberid);
    initialize(result);
    return result;
  }

  public class PrivateOffersToMember extends OfferendpointRequest<com.sp.fanikiwa.entity.offerendpoint.model.CollectionResponseOffer> {

    private static final String REST_PATH = "PrivateOffersToMember/{memberid}";

    /**
     * Create a request for the method "privateOffersToMember".
     *
     * This request holds the parameters needed by the the offerendpoint server.  After setting any
     * optional parameters, call the {@link PrivateOffersToMember#execute()} method to invoke the
     * remote operation. <p> {@link PrivateOffersToMember#initialize(com.google.api.client.googleapis.
     ...
     * @since 1.13
     */
    protected PrivateOffersToMember(java.lang.Long memberid) {
    ...
    @Override
    public PrivateOffersToMember setAlt(java.lang.String alt) {
      return (PrivateOffersToMember) super.setAlt(alt);
    }

    @Override
    public PrivateOffersToMember setFields(java.lang.String fields) {
      return (PrivateOffersToMember) super.setFields(fields);
    }

    @Override
    public PrivateOffersToMember setKey(java.lang.String key) {
      return (PrivateOffersToMember) super.setKey(key);
    }

    @Override
    public PrivateOffersToMember setOauthToken(java.lang.String oauthToken) {
      return (PrivateOffersToMember) super.setOauthToken(oauthToken);
    }

    @Override
    public PrivateOffersToMember setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (PrivateOffersToMember) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public PrivateOffersToMember setQuotaUser(java.lang.String quotaUser) {
      return (PrivateOffersToMember) super.setQuotaUser(quotaUser);
    }

    @Override
    public PrivateOffersToMember setUserIp(java.lang.String userIp) {
      return (PrivateOffersToMember) super.setUserIp(userIp);
    }
    ...
    public PrivateOffersToMember setMemberid(java.lang.Long memberid) {
    ...
    public PrivateOffersToMember setCount(java.lang.Integer count) {
      this.count = count;
      return this;
    }
    ...
    public PrivateOffersToMember setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }

    @Override
    public PrivateOffersToMember set(String parameterName, Object value) {
      return (PrivateOffersToMember) super.set(parameterName, value);
    }
  }
