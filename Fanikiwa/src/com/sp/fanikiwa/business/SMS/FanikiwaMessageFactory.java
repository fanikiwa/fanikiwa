...
public class FanikiwaMessageFactory {
	...
	private static MpesaDepositMessage ParseMpesaMessage(
		...
		/*
		 * FX12UB729 Confirmed. on 31/10/14 at 7:49 PM Ksh220.00 received from
		 * FRANCIS MURAYA 254715413144. Account Number 10 New Utility balance is
		 * Ksh420.00
		 */
		// populate generic from abstract
		...
		String bal = lines[4].split("\\s+")[lines[4].length() - 1].split("KSH")[0];

		mo.SenderTelno = OriginatingAddress;
		mo.CustomerTelno = telno.split("\\.")[0];
