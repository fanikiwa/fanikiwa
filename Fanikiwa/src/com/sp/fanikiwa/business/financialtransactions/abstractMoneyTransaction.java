...
public abstract class abstractMoneyTransaction
{
    ...
    private void Initialize()
    {
        ...
        if (!StringExtension.isNullOrEmpty( TransactionType.getChargeWho()) && TransactionType.getChargeWho().equals("C"))
        {
        ...
        if (TransactionType.getCommissionCrAccount() != 0) 
        	CommissionCreditAccount = aep.getAccount(TransactionType.getCommissionCrAccount());
        ...
        if (TransactionType.getCommissionTransactionType() != 0) 
        	CommissionTransactionType = tep.getTransactionType(TransactionType.getCommissionTransactionType());
